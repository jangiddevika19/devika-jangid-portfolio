...
function Hero() {
  ...
  const badges = [
    ...
    { 
      icon: SiSpringboot, 
      label: "Spring Boot", 
      position: "lg:top-1/4 lg:-right-10", 
      delay: "0.6s" 
    },
    ...
    { 
      icon: FaReact, 
      label: "React.js", 
      position: "lg:bottom-1/3 lg:-left-10", 
      delay: "1.2s" 
    },
    ...
    { 
      icon: SiMysql, 
      label: "MySQL", 
      position: "lg:-bottom-6 lg:right-10", 
      delay: "1.8s" 
    },
    ...
    { 
      icon: FaNodeJs, 
      label: "Node.js", 
      position: "lg:top-4 lg:right-1/4", 
      delay: "0.3s" 
    },
  ];
  ...
  return (
    ...
    <section
      id="home"
      className="relative min-h-screen bg-slate-950 text-white overflow-hidden pt-12 md:pt-16"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-8 py-6 md:py-12 grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
        ...
        <div>
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-slate-900/60 backdrop-blur-xl px-4 py-1.5 mb-5">
          ...
          <p className="text-cyan-400 uppercase tracking-[4px] text-xs sm:text-sm font-semibold mb-3">
          ...
          <TypeAnimation
            ...
            className="text-xl sm:text-2xl lg:text-3xl text-slate-200 font-medium mb-4"

          />



          <p className="text-slate-400 text-sm sm:text-base lg:text-lg leading-7 max-w-xl mb-7">

            I build scalable, responsive and user-focused web applications
            using Java, Spring Boot, React.js and MySQL. Passionate about
            writing clean code and turning ideas into efficient,
            real-world products.
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="w-11 h-11 rounded-xl bg-slate-900/60 backdrop-blur-xl border border-slate-800 flex items-center justify-center text-slate-300 hover:text-cyan-400 hover:border-cyan-400/50 transition-all"
            >
        ...
        <div className="relative mt-6 lg:mt-0">
          ...
          <div className="relative bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl overflow-hidden hover:border-cyan-400/30 transition duration-500">
            ...
            <div className="p-5 sm:p-8 font-mono text-xs sm:text-sm leading-7 overflow-x-auto">
              ...
              <p className="ml-4 sm:ml-6 text-cyan-400">
