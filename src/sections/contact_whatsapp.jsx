          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl p-5 bg-slate-900/60 backdrop-blur-xl border border-slate-800">
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="https://wa.me/9166532806?text=Hello%20Devika,%20I%20visited%20your%20portfolio"
                  target="_blank"
                  rel="noreferrer"
                  className="w-11 h-11 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-green-400 hover:border-green-400 transition"
                >
